...
public abstract class BaseAdapter<T, H extends BaseViewHolder> extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseAdapter(Context context, int layoutResId) {
        this(context, layoutResId, null, 0);
    }


    public BaseAdapter(Context context, int layoutResId, List<T> datas, int index) {
    ...
    public void onBindViewHolder(BaseViewHolder viewHoder, int position) {
        ...
        mPosition=position;
        convert((H) viewHoder, item, index);
    }
...
//        this.notifyItemRangeRemoved(0,itemCount);
     ...
     */
    protected abstract void convert(H viewHoder, T item, int index);
