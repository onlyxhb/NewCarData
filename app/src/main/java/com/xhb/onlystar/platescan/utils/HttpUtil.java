package com.xhb.onlystar.platescan.utils;
...
public class HttpUtil {
		...
		public static final String USERNAME="f93eaad6-b7e2-4cff-9d5a-413c34f82a88";//开发者平台API帐号
		public static final String PASSWORD="YFBzWTiNKozKNmLhkhTzkoZQLAJcfk";//开发者平台API密码
